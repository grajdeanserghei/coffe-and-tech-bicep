...
// Variables
var hostingPlanName = 'plan-coffetechs2-${env}-${location}-001'
var webSiteName = 'app-coffetechs2-site-${env}-${location}-001'
var appInsightsName = 'appi-coffetechs2-${env}-${location}-001'
